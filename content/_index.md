---
title: "Jari Kasandiredjo"
---

<img src="https://via.placeholder.com/150" alt="Profile" style="width: 150px; height: 150px; border-radius: 50%; margin-bottom: 20px;">

Data Science and AI Technology @ TU Delft. Interested in RL, and applying machine learning to medical and bioinformatics contexts.

## Experience

<div class="job">
<h3>Research Intern · Erasmus MC</h3>
<p class="job-meta">jan. 2025 - jun. 2025 · 6 mnden · Rotterdam, Zuid-Holland, Nederland</p>
<p>For my Bachelor's thesis I interned at the department of Clinical Bioinformatics at Erasmus MC for five months. I validated and extended their deep learning with transfer learning framework that helps overcome the data scarcity problem when predicting drug response for rare cancers.</p>
<p>Built and tuned neural networks using Python (Keras, PyTorch) and performed differential expression analysis, normalization, and batch effect removal on RNA-seq data using R (edgeR).</p>
<p>Conducted Gene Set Enrichment Analysis (GSEA) to interpret model weights, identifying biological pathways driving drug resistance and sensitivity.</p>
</div>
...
<div class="job">
<h3>Full Stack Developer · Bonnie BV</h3>
<p class="job-meta">sep. 2022 - jun. 2023 · 10 mnden · Leiden, Zuid-Holland, Nederland</p>
...
<div class="job">
<h3>Teaching Assistant · Vrije Universiteit Amsterdam (VU Amsterdam)</h3>
<p class="job-meta">jan. 2023 - apr. 2023 · 4 mnden · Amsterdam, Noord-Holland, Nederland</p>
<p>Supported students in creating Assembly programs for the Computer Organization course, graded assignments, and provided communication between students and teachers.</p>
</div>
...
<p class="job-meta">Master of Science - MS · Data Science and Artificial Intelligence Technology · sep. 2025 - jun. 2027</p>
</div>
...
<p class="job-meta">Bachelor's degree · Bioinformatics · 2019 - 2022</p>
</div>

<div class="job">
<h3>Delft University of Technology</h3>
<p class="job-meta">Bachelor's degree · Computer Science · sep. 2018 - jan. 2019</p>
</div>
